        ...
        if(this.state.redireccion){    
                ...
                return(
                    <>
                        <tr key={index}  >
                            ...
                            <td>{moment.utc(registro.service_proximo).format('MM/DD/YYYY')}</td>
            ...
            return(
                <>
                    <tr key={index}  >
                        <td>{registro.id_mantenimiento}</td>
                        <td>{moment.utc(registro.servive_proximo).format('MM/DD/YYYY')}</td>
                        <td>{moment.utc(registro.fecha).format('MM/DD/YYYY')}</td>
                        <td>{registro.observaciones}</td>
                        <td>{registro.id_vehiculo}</td>
                        <td>
...
//tenemos el id y mostramos o no opcion +info
 ...
 //Estado modificar o informar
    ...
    //     debugger
    //     const seleccion = this.state.seleccion ; // Copia el objeto seleccion del estado

    //     if (registro.id_viaje.toString() in seleccion) {
    //       // Si la clave ya existe en seleccion, la eliminamos
    //       delete seleccion[registro.id_viaje.toString()];
    //     } else {
    //       // Si la clave no existe, la agregamos
    //       seleccion[registro.id_viaje.toString()] = [registro.id_viaje, registro.id_tipo];
    //     }
